...
## 3. Gesture-based Media Controls (4.5/6P)
* Three hand poses are tracked and distinguished reliably  
    * semi, 'like' needs some reposing to get detected (1.5P)
...
* Low latency between gesture and the systems reaction
    * yep (1P)
* We had to debug your code and reposition (and resize) the bounding box to test the application (-1)

# Code Quality (-0.5P)
* README is a bit too short 